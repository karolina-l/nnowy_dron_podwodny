...
example.out: Dr3D_gnuplot_api.o main.o prostopadloscian.o p_prost.o dron.o sruba.o interfejs_drona.o graniastoslup.o dno.o tafla.o templates.o m_obrotu.o
	g++ -o example.out main.o Dr3D_gnuplot_api.o prostopadloscian.o p_prost.o dron.o sruba.o interfejs_drona.o graniastoslup.o dno.o tafla.o templates.o\
	 m_obrotu.o -lpthread
